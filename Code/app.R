...
#load("/Users/rosie/Documents/Micromet/CanPeat/CanPeatSites_Metadata/canpeat-summary/Data/data_tmp/all_data.RData")  # code must have been run first to create this data set
